                ...
                children: [
                  Flexible(
                    child: Text(
                      ...
                      // THEME // style: Theme.of(context).textTheme.bodyText2,
                  ...
                  Padding(
                    ...
                    child: Icon(
                      Icons.open_in_new,
                      // THEME // color: Theme.of(context).textTheme.bodyText2!.color,
                      // THEME // size: Theme.of(context).textTheme.bodyText2!.fontSize,
                    ),
                  )
                ],
              ),
