...
class _AnimatedButtonState extends State<AnimatedButton>
  ...
  void _updateWidth() {
    final theme = Theme.of(context);
    // THEME // final fontSize = theme.textTheme.button!.fontSize!;
    final renderParagraph = RenderParagraph(
      TextSpan(
        text: widget.text,
        style: TextStyle(
          // THEME // fontSize: fontSize,
          // THEME // fontWeight: theme.textTheme.button!.fontWeight,
          // THEME // letterSpacing: theme.textTheme.button!.letterSpacing,
        ),
      ),
    ...
    // THEME // final textWidth = renderParagraph.getMinIntrinsicWidth(fontSize).ceilToDouble() + 45.0;
  ...
  Widget _buildButtonText(ThemeData theme) {
    return FadeTransition(
      ...
      child: AnimatedText(
        text: widget.text,
        // THEME // style: theme.textTheme.button,
      ),
    );
  }
