...
//import 'package:model_flutter/features/auth/data/service/ApiServices.dart';
import '../../../auth/data/service/ApiServices.dart';

import '../../../../core/res/constants.dart';

import '../../data/model/users.dart';
import '../widgets/flutter_login.dart';
...
class LoginScreen extends StatelessWidget {
  ...
  Future<String?> _loginUser(LoginData data) {
    Constants.retourLog = null;
    return Future.delayed(loginTime).then((_) async {
      await ApiService().signInWithEmailAndPassword(data.name, data.password);

      if (Constants.userConnexion.email != data.name ||
          Constants.userConnexion.password != data.password) {
        
        print('Constants.userConnexion.username:' +
            Constants.userConnexion.email);
        print('data.name:' + data.name);
        return 'User not exists';
        

        // return '${Constants.statutConnect.toString()}';
      }
      return null;
    });
  }
...
class IntroWidgetX extends StatelessWidget {
  const IntroWidgetX({Key? key}) : super(key: key);
