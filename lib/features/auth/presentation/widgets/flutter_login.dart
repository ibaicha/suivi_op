...
import '/src/models/user_form_field.dart';
...
class _FlutterLoginState extends State<FlutterLogin>
  ...
  ThemeData _mergeTheme({
    ...
    final isDefaultBlackText = theme.textTheme.headlineMedium!.color ==
        Typography.blackMountainView.headlineMedium!.color;
    ...
    final footerStyle = theme.textTheme.bodyMedium!
        .copyWith(
          color: loginTheme.accentColor ??
              (isDefaultBlackText
                  ? Colors.white
    ...
    final textFieldStyle = theme.textTheme.headlineMedium!
